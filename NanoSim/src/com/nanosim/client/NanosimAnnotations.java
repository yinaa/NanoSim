...
/**
 * The annotations used in {@link Nanosim}.
 */
public class NanosimAnnotations {
  /**
   ...
   */
  public @interface NanosimSource {
  }
   ...
   * example.
   */
  public static @interface NanosimRaw {
    String[] value();
  }
   ...
   */
  public static @interface NanosimStyle {
    String[] value();
  }
}
